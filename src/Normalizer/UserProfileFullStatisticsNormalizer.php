...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class UserProfileFullStatisticsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $data instanceof UserProfileFullStatistics;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new UserProfileFullStatistics();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }

            if (\array_key_exists('anime', $data)) {
                $object->setAnime($this->denormalizer->denormalize($data['anime'], UserProfileFullStatisticsAnime::class, 'json', $context));
                unset($data['anime']);
            }

            if (\array_key_exists('manga', $data)) {
                $object->setManga($this->denormalizer->denormalize($data['manga'], UserProfileFullStatisticsManga::class, 'json', $context));
                unset($data['manga']);
            }
