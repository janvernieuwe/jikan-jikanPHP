...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class CharacterImagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $data instanceof CharacterImages;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new CharacterImages();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }

            if (\array_key_exists('jpg', $data)) {
                $object->setJpg($this->denormalizer->denormalize($data['jpg'], CharacterImagesJpg::class, 'json', $context));
                unset($data['jpg']);
            }

            if (\array_key_exists('webp', $data)) {
                $object->setWebp($this->denormalizer->denormalize($data['webp'], CharacterImagesWebp::class, 'json', $context));
                unset($data['webp']);
            }
