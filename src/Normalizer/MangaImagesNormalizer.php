...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class MangaImagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $data instanceof MangaImages;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new MangaImages();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }

            if (\array_key_exists('jpg', $data)) {
                $object->setJpg($this->denormalizer->denormalize($data['jpg'], MangaImagesJpg::class, 'json', $context));
                unset($data['jpg']);
            }

            if (\array_key_exists('webp', $data)) {
                $object->setWebp($this->denormalizer->denormalize($data['webp'], MangaImagesWebp::class, 'json', $context));
                unset($data['webp']);
            }
